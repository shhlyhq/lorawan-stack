...
const ConfigurationForm = React.memo(props => {
  ...
  return (
    ...
    >
      ...
      >
        <Radio label={sharedMessages.otaa} value={ACTIVATION_MODES.OTAA} disabled={!canCreateJs} />
        <Radio label={sharedMessages.abp} value={ACTIVATION_MODES.ABP} disabled={!canCreateNs} />
        <Radio
